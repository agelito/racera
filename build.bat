...
set SRC_FILES=src/win32_main.c src/window_win32.c src/platform_windows.c src/racera_game.c src/math.c src/opengl.c src/opengl_wgl.c src/renderer.c src/shader.c src/mesh.c src/texture.c
